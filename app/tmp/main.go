...
func main() {
	...
	revel.DefaultValidationKeys = map[string]map[int]string{
		"trawanganserver/app/controllers.Agent.SetService": {
			253: "foto",
		...
		"trawanganserver/app/controllers.Api.AddUser": {
			43: "password",
		},
		"trawanganserver/app/controllers.App.AddUser": {
			104: "password",
		},
		"trawanganserver/app/controllers.App.AddUserWithSosmed": {
			134: "verifyPassword",
			135: "verifyPassword",
		},
		"trawanganserver/app/controllers.App.Upload": {
			376: "avatar",
			377: "avatar",
			379: "avatar",
			384: "err1",
		},
		"trawanganserver/app/controllers.Persons.AddData": {
			98:  "person.Nama",
			99:  "person.Alamat",
		...
		"trawanganserver/app/models.(*Person).Validation": {
			26: "person.Nama",
			31: "person.Alamat",
			36: "person.TempatLahir",
		},
		"trawanganserver/app/models.(*User).Validation": {
			73: "user.Nama",
			80: "user.Username",
			85: "user.Email",
		},
		"trawanganserver/app/models.AgentTravel.Validation": {
			58: "at.NamaAgent",
			60: "at.Alamat",
			65: "at.Notelp",
			71: "at.Email",
